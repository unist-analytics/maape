...
##Output folder(path) should be reassigned
postscript("C:\\Users\\sungil.kim\\Dropbox\\Research_idea\\figs\\Figure 3 - (a).eps",width = 6.0, height = 6.0, horizontal = FALSE, onefile = FALSE, paper = "special")
z=outer(x, y, FUN=APE)
Z=c(z)
X=rep(x,length(y))
...
##Figure image creation
##Output folder(path) should be reassigned
postscript("C:\\Users\\sungil.kim\\Dropbox\\Research_idea\\figs\\Figure 3 - (b).eps",width = 6.0, height = 6.0, horizontal = FALSE, onefile = FALSE, paper = "special")
#dat=cbind(X,Y,Z)
...
##Figure image creation
##Output folder(path) should be reassigned
postscript("C:\\Users\\sungil.kim\\Dropbox\\Research_idea\\figs\\Figure 3 - (c).eps",width = 6.0, height = 6.0, horizontal = FALSE, onefile = FALSE, paper = "special")
...
##Figure image creation
##Output folder(path) should be reassigned
postscript("C:\\Users\\sungil.kim\\Dropbox\\Research_idea\\figs\\Figure 3 - (d).eps",width = 6.0, height = 6.0, horizontal = FALSE, onefile = FALSE, paper = "special")
#dat=cbind(X,Y,Z)
dat_diag=cbind(x,y,diag(z))
#dat_diag=dat[(dat[,1]+dat[,2]==(max(x)+min(x))),]
...
############ Figure 4 ###############
##Visualization of APE and AAPE on [1,10] x [1,10].
...
##Figure image creation
##Output folder(path) should be reassigned
postscript("C:\\Users\\sungil.kim\\Dropbox\\Research_idea\\figs\\Figure 4 - (a).eps",width = 6.0, height = 6.0, horizontal = FALSE, onefile = FALSE, paper = "special")
#dat=cbind(X,Y,Z)
dat_diag=cbind(x,y,diag(z))
#dat_diag=dat[(dat[,1]+dat[,2]==(max(x)+min(x))),]
...
##Figure image creation
##Output folder(path) should be reassigned
postscript("C:\\Users\\sungil.kim\\Dropbox\\Research_idea\\figs\\Figure 4 - (b).eps",width = 6.0, height = 6.0, horizontal = FALSE, onefile = FALSE, paper = "special")
	dat_diag=cbind(x,y,diag(z))
...
##Figure image plotting
plot(dat_diag3[,1],dat_diag3[,3],xlab="",ylab="AAPE",type="l",axes=F)
axis(2, pretty(round(dat_diag3[,3],2),10))
axis(1, at=0:10,labels=c(10:0),line=1)
mtext("F",1,line=1,at=-1)
axis(1, pretty(dat_diag[,1],10),line=3)
...
##Figure image creation
postscript("C:\\Users\\sungil.kim\\Dropbox\\Research_idea\\figs\\Figure 1.eps",width = 8.0, height = 3.0, horizontal = FALSE, onefile = FALSE, paper = "special")
...
############ Figure 8 ###############
##Actual data and two different forecasts from the 25th to 36th months
...
postscript("C:\\Users\\sungil.kim\\Dropbox\\Research_idea\\figs\\Figure 8.eps",width = 5.0, height = 5.0, horizontal = FALSE, onefile = FALSE, paper = "special")
...
postscript("C:\\Users\\sungil.kim\\Dropbox\\Research_idea\\figs\\Figure 5.eps",width = 6.0, height = 6.0, horizontal = FALSE, onefile = FALSE, paper = "special")
